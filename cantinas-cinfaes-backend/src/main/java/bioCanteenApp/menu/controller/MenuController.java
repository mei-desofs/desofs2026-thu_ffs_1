...
public class MenuController {
    ...
    public MenuDto createMenu(@RequestBody MenuDto dto) {
        ...
        log.info("Menu created successfully with id: {}", created.getId());
    ...
    public MenuDto generateMenu(
        ...
        log.info("Generating menu from {} to {}", startDate, endDate);

        MenuDto menu = menuService.generateMenu(
        ...
        log.info(
                "Menu generated successfully with id: {} from {} to {}",
                menu.getId(),
                startDate,
                endDate
        );
    ...
    public ResponseEntity<List<MenuDto>> getMenusByWeek(
        ...
        log.info("Fetching menus between {} and {}", startDate, endDate);
    ...
    public ResponseEntity<Void> publishMenu(
        ...
        log.info(
                "Menu published successfully from {} to {} by dietitian id: {}",
                startDate,
                endDate,
                dietitianId
        );
    ...
    public ResponseEntity<Void> closeMenu(
        ...
        log.warn("Closing menu from {} to {}", startDate, endDate);
        ...
        log.info(
                "Menu closed successfully from {} to {}. Planned quantities found: {}",
                startDate,
                endDate,
                planned.isPresent()
        );
